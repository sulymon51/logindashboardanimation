...
class HistoryDetail extends StatefulWidget {
  ...
  final String dsaname;
  final String amount;
  final String driverpic;


  HistoryDetail({this.id, this.ridid,this.drivername,this.driverpic,this.staname,this.dsaname,this.amount});
                              ...
                              child:  SizedBox(
                                ...
                                child: Hero(
                                  ...
                                  child: CircleAvatar(
                                      ...
                                      backgroundImage: CachedNetworkImageProvider('${widget.driverpic}',
                                      )
                                  ),
                                ),
                              ),
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Column(
                                      ...
                                      children: <Widget>[
                                        Container(
                                          child: Text('${widget.drivername}',style: textBoldBlack,),
                                        ),
                    ...
                    new Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          new Row(
                            children: <Widget>[
                              new Text("Bill Details (WalletPayment)",
                                style: TextStyle(
                                    color: blackColor,
                          ...
                          Container(
                            ...
                            child: new Row(
                              ...
                              children: <Widget>[
                                ...
                                new Text("\₦" '${widget.amount}', style: textStyle,),
                              ],
                            ),
                          ),
                          Container(
