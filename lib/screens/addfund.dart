...
import 'package:login_dash_animation/screens/driver/pages/HomePage.dart';
      ...
      child: Material(
        ...
        child: MaterialButton(
          ...
          // },
            ...
            onPressed: () {
              var webAddress = "https://ridezmyway.com/apiall/mob/addfundapi.php?ibd=" + id + "&abd="+ amountt; 
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (ctx) => WebviewScaffold(
            ...
            url: url,
            appBar: AppBar(title: Text('Payment'), backgroundColor: Colors.deepOrange,),
            bottomNavigationBar: BottomAppBar(
            shape: const CircularNotchedRectangle(),
            child: Container(
              height: 70.0,
