...
//
//     final requestRide = requestRideFromJson(jsonString);

import 'dart:convert';

List<RequestRide> requestRideFromJson(String str) => List<RequestRide>.from(json.decode(str).map((x) => RequestRide.fromMap(x)));

String requestRideToJson(List<RequestRide> data) => json.encode(List<dynamic>.from(data.map((x) => x.toMap())));
...
class RequestRide {
    ...
    factory RequestRide.fromMap(Map<String, dynamic> json) => RequestRide(
        id: json["id"],
