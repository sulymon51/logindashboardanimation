...
//
//     final requestRidez = requestRidezFromJson(jsonString);

import 'dart:convert';

List<RequestRidez> requestRidezFromJson(String str) => List<RequestRidez>.from(json.decode(str).map((x) => RequestRidez.fromMap(x)));

String requestRidezToJson(List<RequestRidez> data) => json.encode(List<dynamic>.from(data.map((x) => x.toMap())));
...
class RequestRidez {
    ...
    factory RequestRidez.fromMap(Map<String, dynamic> json) => RequestRidez(
        id: json["id"],
