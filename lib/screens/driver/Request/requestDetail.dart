...
class RequestDetail extends StatefulWidget {
 ...
 RequestDetail({this.id, this.idaa, 
 this.rname , 
 this.sname, 
 this.dname, 
 this.aname, 
          ...
          if (value == 1) {
            setState(() {
              Navigator.pushReplacement(
                context,
                new MaterialPageRoute(builder: (context) => new RequestScreen()),
              );
            });
            print(message);
...
Future navigateToPro() async {
  ...
  Future navigateToDetail() async {
   ...
   String idas= '${widget.idaa}';
   String status = '${widget.sstatus}';
    var url = 'https://ridezmyway.com/apiall/updateridapi1.php';
    final response = await http.post(url, body: {
      "rideid": idas,
      "status": status,
      "statusa": "awaiting",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Request Detail', style: TextStyle(color: Colors.deepOrange),
        ),
            ...
            builder: (context) {
              ...
              if (newa == 'pending') {
                ...
                RaisedButton( 
                  ...
                  elevation: 0.0,
                  color: Colors.deepOrange,
                  child: Text('Confirm your Arrival'.toUpperCase(),style: headingWhite,
                  ),
                  onPressed: (){
                    navigateToPic();
                    // Navigator.of(context).push(MaterialPageRoute(builder: (context) => PickUp()));
                ...
                RaisedButton( 
                  ...
                  elevation: 0.0,
                  color: Colors.grey,
                  child: Text('Waiting For Trip to Start'.toUpperCase(),style: headingWhite,
                  ),
                  onPressed: (){
                    // navigateToStt();
                    // Navigator.of(context).push(MaterialPageRoute(builder: (context) => PickUp()));
                ...
                RaisedButton( 
                  ...
                  onPressed: (){
                    navigateToStt();
                    // Navigator.of(context).push(MaterialPageRoute(builder: (context) => PickUp()));trip started
                  },
                ),
              );
                ...
                RaisedButton( 
                  ...
                  elevation: 0.0,
                  color: Colors.deepOrange,
                  child: Text('Request Payment'.toUpperCase(),style: headingWhite,
                  ),
                  onPressed: (){
                    navigateToStttt();
                    // Navigator.of(context).push(MaterialPageRoute(builder: (context) => PickUp())); navigateToStttt
                  },
                ),
              );
                ...
                RaisedButton( 
                  ...
                  elevation: 0.0,
                  color: Colors.deepOrange,
                  child: Text('Done'.toUpperCase(),style: headingWhite,
                  ),
                  onPressed: (){
                    // navigateToStttt();
                    // Navigator.of(context).push(MaterialPageRoute(builder: (context) => PickUp())); navigateToStttt
                ...
                RaisedButton( 
                  ...
                  elevation: 0.0,
                  color: Colors.deepOrange,
                  child: Text('Proceed'.toUpperCase(),style: headingWhite,
                  ),
                  onPressed: (){
                    navigateToPro();
                    // Navigator.of(context).push(MaterialPageRoute(builder: (context) => PickUp()));
