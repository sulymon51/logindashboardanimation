...
class CarPicture extends StatefulWidget {
  CarPicture({Key key}) : super(key: key);

  @override
  _CarPictureState createState() => _CarPictureState();
}
...
File _imageFile;
  ...
  String baseUrl = 'https://ridezmyway.com/apiall/doc1tup.php';
    ...
    if (response == null || response.containsKey("error")) {
      ...
      Toast.show("Documents Uploaded Successfully!!!", context,
          ...
          Navigator.push(context,
                  MaterialPageRoute(builder: (context) => CarPicturea()));
    }
  }
  void _resetState() {
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Front Driver License'),
      ),
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: OutlineButton(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text('Front Of Your Diver License'),
                ],
              ),
            ),
          ),
